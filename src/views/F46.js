...
import { useF46BattleSequence } from "../hooks/useF46BattleSequence";
import { BattleField } from "../components/BattleField";
import { handleLevelUp } from "../utils/handleLevelUp";
import Kyle from "../js/enemies/kyle";

export default function F46 ({toMenu, toNext, aLv, setALv, bLv, setBLv, cLv, setCLv}) {
    let aPrime = new Mack();
    ...
    const {
        ...
        inSeq,
        announcerMessage
    } = useF46BattleSequence(sequence, active, a, b, c, e, setRotating, setActive, field)
    ...
    return (
        <div>
            <BattleField announcerMessage={announcerMessage} activechar={active} echar={e} setRotating={setRotating} setSequence={setSequence} setActive={setActive} handleCloseStart={handleCloseStart} turn={turn} rotating={rotating} toMenu={toMenu} toNext={toNext} open={open} openStart={openStart} a={a} b={b} c={c} floor={46} field={field}/>
